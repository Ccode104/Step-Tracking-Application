...
// Defined Twice(2 versions)--->>>>> UPDATED***
...
void main()
{
    ...
    else
    {
        ...
        while (value != -1)
        {
            ...
            {
                // get_top3();
                //  Call get_top3 once to activate this function
            ...
            else if (value == 9)
            {
                ...
                printf("Enter the two ids to be merged : ");
                scanf("%u%u", &id1, &id2);
